...
const QRScanner = ({ onScan, onClose }) => {
  ...
  const handleTestScan = (qrCode) => {
    console.log('🧪 TEST QR CODE CLICKED:', qrCode)
    console.log('🎯 Processing test QR code...')
    onScan(qrCode)
    console.log('🚀 Test QR scan success flow completed!')
  }
